...
public class modifiedReticle : MonoBehaviour, IGvrGazePointer {
		...
		public void OnGazeTriggerStart(Camera camera) {
				...
				ExecuteEvents.Execute(gazedAt,null,(dragDropObjectHandler handler,BaseEventData data)=>handler.handleTriggerStart());
		...
		public void OnGazeTriggerEnd(Camera camera) {
				...
				ExecuteEvents.Execute(gazedAt,null,(dragDropObjectHandler handler,BaseEventData data)=>handler.handleTriggerEnd());
		}
